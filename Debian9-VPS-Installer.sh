...
echo '' >> /etc/profile.d/barts.sh
echo 'XAMJYSSVPN SCRIPT MENU:' >> /etc/profile.d/barts.sh
echo '' >> /etc/profile.d/barts.sh
echo '|==============|' >> /etc/profile.d/barts.sh
echo '|  - accounts  |' >> /etc/profile.d/barts.sh
echo '|  - options   |' >> /etc/profile.d/barts.sh
echo '|  - server    |' >> /etc/profile.d/barts.sh
echo '|==============|' >> /etc/profile.d/barts.sh
echo '' >> /etc/profile.d/barts.sh
